...
activities = {
    ...
    "Music Ensemble": {
        "description": "Perform in orchestral and chamber ensemble settings",
...
def unregister_from_activity(activity_name: str, email: str = Query(..., description="Student email to unregister")):
